<template>
  ...
  <ul>
    ...
    <li>
      <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Novellia Platform</p>
    </li>
    <li>
    ...
    <li>
      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Rektangular Studios Inc, PO Box 68015 Osbourne Village, Winnipeg, Manitoba, R3L 2V9.</p>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Novellia Platform, accessible from <a
          href="https://app.rektangularstudios.com/"
          rel="external nofollow noopener"
          target="_blank"
        >https://app.rektangularstudios.com/</a>
      </p>
    </li>
    <li>
  ...
  <ul>
    <li>
      ...
      <p>
        You may opt-out of certain Google Analytics features through your mobile device settings, such as your device advertising settings or by following the instructions provided by Google in their Privacy Policy: <a
    ...
    <li>
      ...
      <p>
        You can prevent Unity Analytics from using your information by opting-out. To opt-out of Unity Analytics, please visit this page: <a
          href="https://unity3d.com/legal/privacy-policy"
          rel="external nofollow noopener"
          target="_blank"
        >https://unity3d.com/legal/privacy-policy</a>
  ...
  <ul>
    <li>
      <p><strong>Now Payments</strong></p>
      <p>
        Their Privacy Policy can be viewed at <a
          href="https://nowpayments.io/doc/privacy_policy-v1_2_2.pdf"
          rel="external nofollow noopener"
          target="_blank"
        >https://nowpayments.io/doc/privacy_policy-v1_2_2.pdf</a>
      </p>
    </li>
  </ul>
  ...
  <ul>
    <li>
      ...
      <p>
        The information gathered by reCAPTCHA is held in accordance with the Privacy Policy of Google: <a
  ...
  <ul>
    <li>By email: contact@rektangularstudios.com</li>
  </ul>
